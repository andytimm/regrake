...
-   If $f$ is a vector of all the marginal expected values for our raking
...
## {background-image="images/polling_avengers.jpg" background-size="contain"}
...
That said, how you weight is entangled with these, and more flexible weighting
